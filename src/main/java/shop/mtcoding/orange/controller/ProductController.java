...
public class ProductController {
    ...
    @GetMapping("/redirest")
    public void redirest(HttpServletRequest request, HttpServletResponse response) throws IOException {
        // HttpSession session = request.getSession();
        session.setAttribute("name", "seession metacoding");
    ...
    public String apiFindOneProduct(@PathVariable int id, Model model) {
    ...
    public String update(@PathVariable int id, String name, int price, int qty) {
        ...
        if (result == 1) {
            ...
            return "product/{id}/update" + id + "/updateForm";
        }
    }
